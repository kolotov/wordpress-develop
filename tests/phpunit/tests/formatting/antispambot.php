...
#[\PHPUnit\Framework\Attributes\CoversFunction( 'antispambot' )]
class Tests_Formatting_Antispambot extends WP_UnitTestCase {
	...
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_returns_valid_utf8' )]
	 ...
	 * return array[]
	 */
	public static function data_returns_valid_utf8() {
		return array(
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '31992' )]
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_antispambot_obfuscates' )]
	 ...
	 * @return Generator
	 */
	public static function data_antispambot_obfuscates() {
		$addresses = array(
			'example@example.com',
			'#@example.com',
			'πετρος@example.com',
