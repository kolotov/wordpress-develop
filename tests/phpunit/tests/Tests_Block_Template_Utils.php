...
class Tests_Block_Template_Utils extends WP_UnitTestCase {
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '59338' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_FUNCTION, '_inject_theme_attribute_in_template_part_block' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '59452' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_FUNCTION, '_inject_theme_attribute_in_block_template_content' )]
	...
	#[\PHPUnit\Framework\Attributes\Ticket( '59460' )]
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_remove_theme_attribute_in_block_template_content' )]
	...
	#[\PHPUnit\Framework\Attributes\Ticket( '59460' )]
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_remove_theme_attribute_in_block_template_content' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_FUNCTION, '_remove_theme_attribute_from_template_part_block' )]
	...
	public static function data_remove_theme_attribute_in_block_template_content() {
		return array(
			array(
	...
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_FUNCTION, '_block_template_add_skip_link' )]
