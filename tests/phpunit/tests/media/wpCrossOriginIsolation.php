...
class Tests_Media_wpCrossOriginIsolation extends WP_UnitTestCase {
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '65399' )]
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_classic_theme_site_editor_home_routes' )]
	 ...
	 * @return array[]
	 */
	public static function data_classic_theme_site_editor_home_routes() {
		return array(
	...
	#[\PHPUnit\Framework\Attributes\Ticket( '64803' )]
	...
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_FUNCTION, 'wp_set_client_side_media_processing_flag' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '64766' )]
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_elements_that_should_get_crossorigin' )]
	#[\PHPUnit\Framework\Attributes\RunInSeparateProcess]
	#[\PHPUnit\Framework\Attributes\PreserveGlobalState( false )]
	 ...
	 * @return array[]
	 */
	public static function data_elements_that_should_get_crossorigin() {
		return array(
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '64766' )]
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_elements_that_should_not_get_crossorigin' )]
	#[\PHPUnit\Framework\Attributes\RunInSeparateProcess]
	#[\PHPUnit\Framework\Attributes\PreserveGlobalState( false )]
	 ...
	 * @return array[]
	 */
	public static function data_elements_that_should_not_get_crossorigin() {
		return array(
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '65673' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_FUNCTION, 'wp_print_media_templates' )]
