...
class Tests_Post_Thumbnail_Template extends WP_UnitTestCase {
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '59521' )]
	#[\PHPUnit\Framework\Attributes\Ticket( '30017' )]
	#[\PHPUnit\Framework\Attributes\Ticket( '33968' )]
	...
	public static function data_post_thumbnail_size_filter_complex() {
		return array(
			array( 0, 'medium' ),
			array( 1, 'thumbnail' ),
		);
	...
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_FUNCTION, '_wp_post_thumbnail_context_filter' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '58212' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_FUNCTION, '_wp_post_thumbnail_context_filter_add' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '58212' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_FUNCTION, '_wp_post_thumbnail_context_filter_remove' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '58212' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_FUNCTION, 'get_the_post_thumbnail' )]
