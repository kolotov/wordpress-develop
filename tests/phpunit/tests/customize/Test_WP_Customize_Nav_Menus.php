...
class Test_WP_Customize_Nav_Menus extends WP_UnitTestCase {
	 ...
	 *
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Customize_Nav_Menus', 'make_auto_draft_status_previewable' )]
	 ...
	 *
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Customize_Nav_Menus', 'sanitize_nav_menus_created_posts' )]
	 ...
	 *
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Customize_Nav_Menus', 'save_nav_menus_created_posts' )]
	 ...
	 *
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Customize_Nav_Menus', 'filter_wp_nav_menu' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Customize_Nav_Menus', 'filter_wp_nav_menu_args' )]
