...
class Test_WP_Customize_Custom_CSS_Setting extends WP_UnitTestCase {
	 ...
	 *
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Customize_Custom_CSS_Setting', '__construct' )]
	 ...
	 *
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_FUNCTION, 'wp_get_custom_css' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Customize_Custom_CSS_Setting', 'value' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Customize_Custom_CSS_Setting', 'preview' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Customize_Custom_CSS_Setting', 'update' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '39032' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '39259' )]
	...
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_FUNCTION, 'wp_update_custom_css_post' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_FUNCTION, 'wp_custom_css_cb' )]
	 ...
	 *
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Customize_Custom_CSS_Setting', 'validate' )]
