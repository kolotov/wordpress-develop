...
class Tests_View_Config_Data extends WP_UnitTestCase {
	 ...
	 *
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_View_Config_Data', 'set' )]
	 ...
	 *
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_View_Config_Data', 'remove' )]
	 ...
	 *
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_View_Config_Data', 'replace' )]
	 ...
	 *
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_View_Config_Data', 'merge' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '65577' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_View_Config_Data', 'merge' )]
