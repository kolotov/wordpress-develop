...
class WP_Navigation_Fallback_Test extends WP_UnitTestCase {
	...
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_CLASS, 'WP_Navigation_Fallback' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '58557' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Navigation_Fallback', 'get_fallback' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '58750' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Navigation_Fallback', 'get_fallback' )]
