...
class Tests_WP_Site_Icon extends WP_UnitTestCase {
	...
	public function tear_down() {
		...
		remove_filter( 'intermediate_image_sizes', array( $this->wp_site_icon, 'intermediate_image_sizes' ) );
	...
	public function test_insert_cropped_attachment() {
		...
		$cropped       = dirname( $parent_file ) . '/cropped-test-image.jpg';

		$this->assertTrue( copy( $parent_file, $cropped ), 'The cropped image fixture could not be created.' );
