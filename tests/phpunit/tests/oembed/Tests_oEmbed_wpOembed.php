...
class Tests_oEmbed_wpOembed extends WP_UnitTestCase {
	...
	/**
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_oEmbed', 'get_html' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '40673' )]
	...
	/**
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '65068' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_oEmbed', '__construct' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '65068' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_oEmbed', 'get_provider' )]
