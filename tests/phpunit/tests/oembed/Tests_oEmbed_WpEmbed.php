...
class Tests_oEmbed_WpEmbed extends WP_UnitTestCase {
	...
	/**
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Embed', 'maybe_run_ajax_cache' )]
	...
	/**
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_FUNCTION, 'wp_maybe_load_embeds' )]
	...
	/**
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_FUNCTION, 'wp_embed_register_handler' )]
	...
	/**
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_FUNCTION, 'wp_embed_unregister_handler' )]
	...
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Embed', 'autoembed' )]
	...
	/**
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Embed', 'delete_oembed_caches' )]
	...
	/**
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Embed', 'cache_oembed' )]
	...
	/**
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Embed', 'shortcode' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '34115' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Embed', 'shortcode' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '42310' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Embed', 'shortcode' )]
	...
	/**
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Embed', 'run_shortcode' )]
	...
	/**
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Embed', 'maybe_make_link' )]
