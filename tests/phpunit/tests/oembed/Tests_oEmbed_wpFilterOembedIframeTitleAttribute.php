 ...
 *
 */
#[\PHPUnit\Framework\Attributes\CoversFunction( 'wp_filter_oembed_iframe_title_attribute' )]
#[\PHPUnit\Framework\Attributes\Group( 'oembed' )]
class Tests_oEmbed_wpFilterOembedIframeTitleAttribute extends WP_UnitTestCase {

	/**
	 */
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_oembed_iframe_title_attribute' )]
	...
	public static function data_oembed_iframe_title_attribute() {
		return array(
			array(
