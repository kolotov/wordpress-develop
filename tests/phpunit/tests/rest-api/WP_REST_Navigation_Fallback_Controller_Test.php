...
class WP_REST_Navigation_Fallback_Controller_Test extends WP_Test_REST_Controller_Testcase {
	...
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Navigation_Fallback_Controller', 'register_routes' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '58557' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_CLASS, 'WP_REST_Navigation_Fallback_Controller' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '58557' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_Navigation_Fallback', 'update_wp_navigation_post_schema' )]
