...
class WP_Test_REST_Revisions_Controller extends WP_Test_REST_Controller_Testcase {
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '65495' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Revisions_Controller', 'prepare_item_for_response' )]
	 ...
	 * @param string $method The HTTP method to use.
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '40510' )]
	#[\PHPUnit\Framework\Attributes\Ticket( '56481' )]
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_readable_http_methods' )]
	...
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Revisions_Controller', 'get_items' )]
