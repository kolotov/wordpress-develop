...
class WP_REST_Pattern_Directory_Controller_Test extends WP_Test_REST_Controller_Testcase {
	 ...
	 * @since 5.8.0
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Pattern_Directory_Controller', 'register_routes' )]
	 ...
	 * @since 5.8.0
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Pattern_Directory_Controller', 'get_context_param' )]
	 ...
	 * @since 5.8.0
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Pattern_Directory_Controller', 'get_items' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '57501' )]
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_get_items_query_args' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Pattern_Directory_Controller', 'get_items' )]
	 ...
	 * return array[]
	 */
	public static function data_get_items_query_args() {
		return array(
	 ...
	 * @since 5.8.0
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Pattern_Directory_Controller', 'prepare_item_for_response' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\DoesNotPerformAssertions]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Pattern_Directory_Controller', 'get_item_schema' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_get_query_parameters' )]
	#[\PHPUnit\Framework\Attributes\Ticket( '55617' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Pattern_Directory_Controller', 'get_transient_key' )]
