...
class WP_Test_REST_Settings_Controller extends WP_Test_REST_Controller_Testcase {
	...
	/**
	 * Settings expose a collection endpoint without the generic context contract.
	 */
	...
	/**
	 * Settings cannot be created through the generic controller contract.
	 */
	#[\PHPUnit\Framework\Attributes\DoesNotPerformAssertions]
	...
	/**
	 * Settings responses are assembled by get_item().
	 */
	#[\PHPUnit\Framework\Attributes\DoesNotPerformAssertions]
	...
	/**
	 * Settings have no generic item schema method.
	 */
	#[\PHPUnit\Framework\Attributes\DoesNotPerformAssertions]
