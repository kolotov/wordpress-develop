...
class WP_Test_REST_Attachments_Controller extends WP_Test_REST_Post_Type_Controller_Testcase {
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '63668' )]
	...
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_valid_filesize_meta' )]
	 ...
	 */
	public static function data_valid_filesize_meta(): array {
		return array(
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '65670' )]
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_invalid_filesize_meta' )]
	 ...
	 */
	public static function data_invalid_filesize_meta(): array {
		return array(
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '65367' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'get_item_schema' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '65367' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'create_item' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'prepare_item_for_response' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '45269' )]
	#[\PHPUnit\Framework\Attributes\RequiresFunction( 'imagejpeg' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '57957' )]
	#[\PHPUnit\Framework\Attributes\DataProvider( 'rest_upload_filename_spaces' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'insert_attachment' )]
	 ...
	 * @return array
	 */
	public static function rest_upload_filename_spaces() {
		return array(
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '61167' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '64836' )]
	#[\PHPUnit\Framework\Attributes\Ticket( '65517' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '64915' )]
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_still_heic_mime_types' )]
	 ...
	 * @return array[]
	 */
	public static function data_still_heic_mime_types() {
		return array(
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '64915' )]
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_heic_sequence_mime_types' )]
	 ...
	 * @return array[]
	 */
	public static function data_heic_sequence_mime_types() {
		return array(
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '63302' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '64035' )]
	#[\PHPUnit\Framework\Attributes\RequiresFunction( 'imagejpeg' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '64149' )]
	#[\PHPUnit\Framework\Attributes\RequiresFunction( 'imagejpeg' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '64737' )]
	#[\PHPUnit\Framework\Attributes\Ticket( '65329' )]
	#[\PHPUnit\Framework\Attributes\RequiresFunction( 'imagejpeg' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '65708' )]
	#[\PHPUnit\Framework\Attributes\RequiresFunction( 'imagejpeg' )]
	...
	#[\PHPUnit\Framework\Attributes\RequiresFunction( 'imagejpeg' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'create_item' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'sideload_item' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'finalize_item' )]
	...
	public function test_sideload_scaled_unique_filename() {
		...
		$this->assertIsString( $attached_file );
		$attachment_basename = pathinfo( wp_basename( $attached_file ), PATHINFO_FILENAME );
		$scaled_filename     = $attachment_basename . '-scaled.jpg';

		// Sideload with the -scaled suffix based on the attachment's actual filename.
		$request = new WP_REST_Request( 'POST', "/wp/v2/media/{$attachment_id}/sideload" );
		$request->set_header( 'Content-Type', 'image/jpeg' );
		$request->set_header( 'Content-Disposition', 'attachment; filename=' . $scaled_filename );
		$request->set_param( 'image_size', 'scaled' );
		$request->set_body( file_get_contents( self::$test_file ) );
		$response = rest_get_server()->dispatch( $request );
		...
		$this->assertSame( $scaled_filename, $basename, 'Scaled filename should not have numeric suffix appended.' );
	}
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '64798' )]
	#[\PHPUnit\Framework\Attributes\RequiresFunction( 'imagejpeg' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'sideload_item' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'validate_image_dimensions' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '62243' )]
	#[\PHPUnit\Framework\Attributes\RequiresFunction( 'imagejpeg' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'finalize_item' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '65643' )]
	#[\PHPUnit\Framework\Attributes\RequiresFunction( 'imagejpeg' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'sideload_item' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'finalize_item' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '65329' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'register_routes' )]
	...
	#[\PHPUnit\Framework\Attributes\Ticket( '65517' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'create_item' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'create_item_from_url' )]
	...
	#[\PHPUnit\Framework\Attributes\Group( 'ms-required' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'create_item_from_url' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'check_upload_size' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '65517' )]
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_create_item_from_url_rejects_non_image_extension' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'create_item_from_url' )]
	 ...
	 * @return array[]
	 */
	public static function data_create_item_from_url_rejects_non_image_extension() {
		return array(
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '65517' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'get_endpoint_args_for_item_schema' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '65517' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Attachments_Controller', 'create_item_permissions_check' )]
