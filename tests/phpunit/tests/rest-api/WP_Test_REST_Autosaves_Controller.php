...
class WP_Test_REST_Autosaves_Controller extends WP_Test_REST_Post_Type_Controller_Testcase {
	...
	/** Autosaves are not deletable through the REST API. */
	...
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Autosaves_Controller', 'prepare_item_for_response' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '55659' )]
