...
class WP_REST_Global_Styles_Controller_Test extends WP_Test_REST_Controller_Testcase {
	...
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Global_Styles_Controller', 'get_theme_items' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_get_theme_item_invalid_theme_dirname' )]
	#[\PHPUnit\Framework\Attributes\Ticket( '54596' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Global_Styles_Controller', 'get_theme_item' )]
	 ...
	 * @return array
	 */
	public static function data_get_theme_item_invalid_theme_dirname() {
		return array(
			'+'                      => array(
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_get_theme_item' )]
	#[\PHPUnit\Framework\Attributes\Ticket( '54596' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Global_Styles_Controller', 'get_theme_item' )]
	 ...
	 * @return array
	 */
	public static function data_get_theme_item() {
		return array(
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '61911' )]
...
CSS;
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '65640' )]
	#[\PHPUnit\Framework\Attributes\DataProvider( 'data_custom_css_non_string' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Global_Styles_Controller', 'validate_custom_css' )]
