...
class REST_Block_Renderer_Controller_Test extends WP_Test_REST_Controller_Testcase {
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '45098' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Block_Renderer_Controller', 'register_routes' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '45098' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Block_Renderer_Controller', 'get_item' )]
	...
	public function test_get_item_default_attributes() {
		...
		$this->assertSame(
			json_decode( $block_type->render( $defaults ), true ),
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '49387' )]
	 ...
	 *
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '49680' )]
	 ...
	 */
	#[\PHPUnit\Framework\Attributes\Ticket( '45098' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_Block_Renderer_Controller', 'get_item_schema' )]
