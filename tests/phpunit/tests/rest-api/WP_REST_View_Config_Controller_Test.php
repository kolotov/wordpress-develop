<?php
/**
 * Unit tests covering WP_REST_View_Config_Controller functionality.
 *
 * @package WordPress
 * @subpackage REST API
 *
...
class WP_REST_View_Config_Controller_Test extends WP_Test_REST_TestCase {
	 ...
	 *
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_View_Config_Controller', 'register_routes' )]
	 ...
	 *
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_View_Config_Controller', 'get_items_permissions_check' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_View_Config_Controller', 'get_items' )]
	 ...
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_View_Config_Controller', 'get_items_permissions_check' )]
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_View_Config_Controller', 'get_required_capability' )]
	...
	/**
	 * The response body matches wp_get_entity_view_config() for the entity.
	 *
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_View_Config_Controller', 'get_items' )]
	public function test_get_items_matches_underlying_config() {
		...
		$config = wp_get_entity_view_config( 'postType', 'page' );
	 ...
	 *
	 */
	#[WP_PHPUnit_Covers( WP_PHPUnit_Covers::TARGET_METHOD, 'WP_REST_View_Config_Controller', 'get_item_schema' )]
