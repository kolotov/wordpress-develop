...
class WP_Test_REST_Users_Controller extends WP_Test_REST_Controller_Testcase {
	...
	public function test_get_user_empty_capabilities() {
		...
		if ( is_multisite() ) {
			...
			$this->assertInstanceOf( stdClass::class, $data['capabilities'] );
			$this->assertSame( array(), get_object_vars( $data['capabilities'] ) );
			$this->assertInstanceOf( stdClass::class, $data['extra_capabilities'] );
			$this->assertSame( array(), get_object_vars( $data['extra_capabilities'] ) );
		}
	}
	...
	protected function check_user_data( $user, $data, $context, $links ) {
		...
		if ( 'edit' === $context ) {
			...
			$this->assertSame( $user->allcaps, (array) $data['capabilities'] );
			$this->assertSame( $user->caps, (array) $data['extra_capabilities'] );
